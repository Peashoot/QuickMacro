...
namespace DBUtility
{
    ...
    public abstract class DbHelperMySQL
    {
        ...
        public static string connectionString = Decrypt();
        ...
        static string Decrypt()
        {
            ...
            {         
              ...
              int PwdPostion = ConnectionString.LastIndexOf(";"); 

              string connectionString1 = ConnectionString.Substring(0, PwdPostion + 1);
              string pwd = ConnectionString.Substring(PwdPostion + 1);
              string Pwd = DESEncrypt.Decrypt(pwd);
              return connectionString1 + Pwd;
            }
            catch (Exception)
            {
        ...
        public static int GetMaxID(string FieldName, string TableName,string sqlwhere)
        {
            string strsql = "select max(" + FieldName + ")+1 from " + TableName;
